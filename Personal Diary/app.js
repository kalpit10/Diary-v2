...
const passportLocalMongoose = require("passport-local-mongoose");//authenticates users using a username and password.
  ...
  new GoogleStrategy(
    {
      ...
      callbackURL:
        "https://protected-hamlet-37960.herokuapp.com/auth/google/Personal Diary",
